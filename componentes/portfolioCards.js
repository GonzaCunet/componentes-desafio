function addCard(e) {
  ...
  cardEl.innerHTML = `
      <template id="content-container">
          ...
          <a href="" class="content-link"><img class="content-image" src="https://picsum.photos/404/461" alt=""></a>
...
function obtenerData(resultado) {
  ...
  for (let i = 0; i < resultado.items.length; i++) {
    ...
    clone
      ...
      .setAttribute("href", resultado.items[i].fields.url);
    clone
...
function contentful() {
  fetch(
    "https://cdn.contentful.com/spaces/ukcepy6412o4/environments/master/entries?access_token=wweAY9O2Wwd0jn3-NZ4UZ3JwNxatHfvWtG0FL-wLEts&content_type=portfolio"
  )
